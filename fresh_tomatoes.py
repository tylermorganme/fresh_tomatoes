...
<head>
    ...
    <script type="text/javascript" charset="utf-8">
        ...
        $(document).on('click', '.hanging-close, .modal-backdrop, .modal',
         function (event) {
            // Remove the src so player itself gets removed. This is the only
    ...
    <div class="modal" id="trailer">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          aria-hidden="true">
            <img src="https://lh5.ggpht.com/v4-628SilF0HtHuHdu5EzxD7WRq''' \
            '''OrrTIDi_MhEG6_qkNtUK5Wg7KPkofp_VJoF7RS2LhxwEFCO1ICHZlc-o_=s0#w=24&h=24"/>
          </a>
...
<div class="col-md-6 col-lg-4 movie-tile text-center"
    ...
    <div class="img-area text-center">
      <img src="{poster_image_url}" alt="{movie_title} poster" width="100%"
        height="100%">
